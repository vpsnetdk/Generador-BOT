...
DIR="/etc/http-shell"
LIST="-SPVweN"
#wget -O /bin/ejecutar/v-new.log https://raw.githubusercontent.com/drowkid01/Multi-Script/main/ChuGH-5.7u/adm-lite/v-local.log &>/dev/null

v1="1.2" #$(cat /bin/ejecutar/v-new.log)
v2="1.2" #$(cat <${SCPT_DIR}/v-local.log)
...
bot_menu() {
    ...
    [[ ! -e "${CIDdir}/confbot.sh" ]] && wget --no-check-certificate -O ${CIDdir}/confbot.sh https://raw.githubusercontent.com/vpsnetdk/Generador-BOT/main/Code-BOT-General/intBOT.sh &>/dev/null && chmod +rwx ${CIDdir}/confbot.sh
